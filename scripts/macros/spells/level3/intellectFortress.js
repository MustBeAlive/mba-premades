...
export async function intellectFortress({ speaker, actor, token, character, item, args, scope, workflow }) {
    ...
    const effectData = {
        ...
        'description': `
            <p>You have advantage on Intelligence, Wisdom, and Charisma saving throws, as well as resistance to psychic damage for the duration.</p>
        `,
        'duration': {
            'seconds': 3600
        },
        'changes': [
            ...
            },
            {
                ...
                'mode': 2,
                'value': "Intellect Fortress: you have advantage on Intelligence saving throws.",
                'priority': 20
            },
            {
                'key': 'flags.adv-reminder.message.ability.save.wis',
                'mode': 2,
                'value': "Intellect Fortress: you have advantage on Wisdom saving throws.",
                'priority': 20
            },
            {
                'key': 'flags.adv-reminder.message.ability.save.cha',
                'mode': 2,
                'value': "Intellect Fortress: you have advantage on Charisma saving throws.",
                'priority': 20
            }
        ],
        'flags': {
